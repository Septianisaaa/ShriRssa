...
@section('title', 'Bukpa (Buku Panduan) - SHRI RSSA')
@section('header_title', 'Bukpa (Buku Panduan Pengguna)')
...
@section('content')
    ...
    <div class="guide-section" style="border-left: 4px solid var(--primary);">
        <div class="guide-title">
            <i class="fa-solid fa-calculator"></i> Aturan Medis & Formula Otomatis Sistem
        </div>
        <ul class="rule-list">
            <li class="rule-item">
    ...
    <div class="guide-section">
        <div class="guide-title">
            <i class="fa-solid fa-bed"></i> Modul Sensus Harian & Export
        </div>
        <ol style="margin-left: 1.25rem; font-size: 0.85rem; color: var(--text-dark); display: flex; flex-direction: column; gap: 0.5rem;">
            <li>Pilih ruangan dan tanggal sensus pada menu <strong>Sensus Harian</strong>.</li>
            <li>Isi form <strong>Pasien Masuk (MRS)</strong> dengan Tanggal & Jam MRS lengkap.</li>
            <li>Untuk memproses pasien keluar, klik tombol <strong>Catat KRS</strong> pada tabel pasien aktif.</li>
            <li>Klik tombol hijau <strong>Export Rekap Sensus (CSV/Excel)</strong> untuk mengunduh rekapitulasi bulanan ruangan.</li>
        </ol>
    </div>

    <div class="guide-section">
        <div class="guide-title">
            <i class="fa-solid fa-right-left"></i> Modul Mutasi Pindahan (Transfer In / Out)
        </div>
        <ol style="margin-left: 1.25rem; font-size: 0.85rem; color: var(--text-dark); display: flex; flex-direction: column; gap: 0.5rem;">
